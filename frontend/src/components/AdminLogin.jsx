...
function AdminLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (success) {
        ...
        setIsAuthenticated(true); // Set the state directly too
      } else {
  ...
  return (
    <div className="relative max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-lg">
      {/* Show the Add Funding button if authenticated */}
      {isAuthenticated && <AddFundingButton />}
      ...
      {!isAuthenticated ? (
        ...
        <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-4 text-center">
          You are logged in as admin. Use the button in the top right to add funding details.
        </div>
      )}
